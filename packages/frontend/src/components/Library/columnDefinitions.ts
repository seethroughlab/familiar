...
export const COLUMN_DEFINITIONS: ColumnDef[] = [
  ...
  },
  {
    ...
    label: 'Speechiness',
    shortLabel: 'Speech',
    getValue: (t) => t.features?.speechiness,
    width: '4.5rem',
    align: 'right',
    format: formatPercent,
    category: 'analysis',
    sortField: 'speechiness',
  },
  {
    id: 'brightness',
    label: 'Brightness',
    shortLabel: 'Bright',
    getValue: (t) => t.features?.brightness,
    width: '4.5rem',
    align: 'right',
    format: formatPercent,
    category: 'analysis',
  ...
  {
    id: 'harmonic_complexity',
    label: 'Harmonic Complexity',
    shortLabel: 'Harm',
    getValue: (t) => t.features?.harmonic_complexity,
    width: '4.5rem',
    align: 'right',
    format: formatPercent,
    category: 'analysis',
    sortField: 'harmonic_complexity',
  },
  {
    id: 'swing_ratio',
    label: 'Swing',
    shortLabel: 'Swing',
    getValue: (t) => t.features?.swing_ratio,
    width: '4.5rem',
    align: 'right',
    format: formatPercent,
    category: 'analysis',
    sortField: 'swing_ratio',
  },
  {
    id: 'syncopation',
    label: 'Syncopation',
    shortLabel: 'Sync',
    getValue: (t) => t.features?.syncopation,
    width: '4.5rem',
    align: 'right',
    format: formatPercent,
    category: 'analysis',
    sortField: 'syncopation',
  },
];
