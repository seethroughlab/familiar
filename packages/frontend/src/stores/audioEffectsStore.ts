...
// ============================================================================
// Native Audio Engine Sync — Registration Pattern
// The iOS package calls registerNativeEffectsSync() to push state changes
// to AVAudioEngine. Keeps @capacitor deps out of the shared package.
// ============================================================================

export type { AudioEffectsState };

export function registerNativeEffectsSync(
  cb: (state: AudioEffectsState) => void,
): () => void {
  // Sync initial state immediately
  cb(useAudioEffectsStore.getState());
  // Subscribe to future changes
  return useAudioEffectsStore.subscribe(cb);
}
