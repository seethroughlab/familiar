...
export function ContentToolbar() {
  ...
  if (!isLibraryView) {
    return (
      <div className={`px-4 py-2 flex items-center justify-end border-b ${light ? 'border-zinc-200 bg-white/80' : 'border-zinc-800/50 bg-zinc-900/80'} backdrop-blur-sm`}>
        {indicators}
      </div>
    );
  }
  ...
  return (
    <div className={`px-4 py-2 flex items-center gap-2 border-b ${light ? 'border-zinc-200 bg-white/80' : 'border-zinc-800/50 bg-zinc-900/80'} backdrop-blur-sm`}>
